...
internal sealed class TrayApp : ApplicationContext
{
    ...
    internal TrayApp()
    {
        ...
        // Четверть секунды, а не одна: при секунде значок отставал от реального переключения
        // настолько, что это читалось как «дёргается». Два вызова user32 — цена незаметная.
